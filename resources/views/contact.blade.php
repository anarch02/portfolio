              ...
              <form action="{{route('send_message')}}" method="post" role="form" class="php-email-form">
                ...
                <div class="row">
                  <div class="col-md-6 form-group">
                    <input type="text" name="name" class="form-control" id="name" placeholder="{{__('contact.name')}}" required>
                  </div>
                ...
                <div class="form-group mt-3">
                  <textarea class="form-control" name="message" rows="5" placeholder="{{__('contact.message')}}" required></textarea>
                </div>
                <div class="my-3">
                ...
                <div class="text-center"><button type="submit">{{__('contact.send')}}</button></div>
              </form>
          </div>
